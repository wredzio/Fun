...
namespace GeneticAkka.Actors
{
    public abstract class ActorCreator<T> where T : ActorBase
    {
        ...
        public virtual Props GetChild(string actorNameKey, IUntypedActorContext context) => _propLookup[actorNameKey](context);

        public virtual void CreateChild(string name) => _propLookup.Add(name, (context) => context.DI().Props<T>());
    }
}
